#!/usr/bin/env python3
"""
Figma MCP Streamable HTTP Client

Figma MCP サーバーに Streamable HTTP で接続し、
Figmaツール（デザインコンテキスト取得・スクリーンショット等）を実行する。
"""
...
class FigmaMCPClient:
    """Figma MCP Streamable HTTPクライアント"""
    ...
    def _parse_sse(self, sse_text: str) -> Dict[str, Any]:
        ...
        raise FigmaMCPError(f"Invalid SSE format: {sse_text[:200]}")
    ...
    def _send_request(self, method: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise FigmaMCPError(f"HTTP request failed: {e}") from e
